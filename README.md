...
### ⚙️ Path 2: Compress the Quantum Forest
...
- **Compile each of the three provided circuits** to *two different target architectures*:
  1. **An all-to-all connectivity** quantum computer *of your choice*, and  
  2. **IBM’s Fez machine**, a representative of IBM’s heavy-hex QPU family.
